...
public class SqliteTrackingRepository implements ITrackingRepository {
    private static final Logger log = LoggerFactory.getLogger(SqliteTrackingRepository.class);
    private final JdbcTemplate jdbcTemplate;

    public SqliteTrackingRepository(JdbcTemplate jdbcTemplate) {
